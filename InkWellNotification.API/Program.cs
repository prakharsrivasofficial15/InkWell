...
using InkWellNotification.API.BackgroundServices;
using InkWellNotification.API.Data;
using InkWellNotification.API.Interfaces;
using InkWellNotification.API.Repositories;
using InkWellNotification.API.Services;
...
builder.Services.AddHostedService<CommentAddedConsumer>();
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title       = "InkWell Notification API",
        Version     = "v1",
        Description = "Manages in-app notifications with Service Bus event consumers."
    });
