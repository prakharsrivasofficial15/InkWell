...
using InkWellMedia.API.Repositories;
using InkWellMedia.API.Services;
...
// EF Core → Azure SQL
builder.Services.AddDbContext<MediaDbContext>(opts =>
    opts.UseSqlServer(
...
builder.Services.AddSingleton(_ =>
    new BlobServiceClient(
        builder.Configuration["inkwell-storage-connection"]));
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version     = "v1",
        Description = "Handles file uploads to Azure Blob Storage with metadata management."
    });
