...
public class PostServiceImpl : IPostService
{
    ...
    public PostServiceImpl(IPostRepository postRepo, IConnectionMultiplexer redis)
    {
        _postRepo  = postRepo;
        _redis     = redis;
    ...
    public async Task<PostResponse> PublishPostAsync(Guid postId, Guid authorId)
    {
        var post = await GetOwnedPostAsync(postId, authorId);
    ...
    public async Task<PostResponse> UnpublishPostAsync(Guid postId, Guid authorId)
    {
        var post = await GetOwnedPostAsync(postId, authorId);
